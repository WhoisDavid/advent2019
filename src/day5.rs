...
fn test_case_day5_equals_position() {
    ...
    assert_eq!(run_program(program, &[8]), 1);
    assert_eq!(run_program(program, &[9]), 0);
    assert_eq!(run_program(program, &[7]), 0);
}

#[test]
fn test_case_day5_less_position() {
    let program = &[3, 9, 7, 9, 10, 9, 4, 9, 99, -1, 8];
    assert_eq!(run_program(program, &[8]), 0);
    assert_eq!(run_program(program, &[9]), 0);
    assert_eq!(run_program(program, &[7]), 1);
}
...
fn test_case_day5_jump_position() {
    ...
    assert_eq!(run_program(program, &[0]), 0);
    assert_eq!(run_program(program, &[99]), 1);
    assert_eq!(run_program(program, &[11]), 1);
}
...
fn test_case_day5_large() {
    ...
    assert_eq!(run_program(program, &[9]), 1001);
    assert_eq!(run_program(program, &[7]), 999);
}
